<template>
    ...
    <div id="main-content" class="mx-3 mt-4 w-100 bg-white border">
        ...
        <div class="px-3 py-4 d-flex justify-content-between border-bottom">
            ...
            <div class="me-3">
                <button class="btn btn-info text-white" @click="submitEditarJuego"><i
                        class="fas fa-user-plus fa-fw pr-2"></i> Editar
                    juego</button>
            </div>
        </div>
        <form id="game-form" class="m-auto mt-5" action="javascript:void(0)" @submit.prevent="editarJuego" method="post">
            <div class="d-md-flex px-4">
                ...
                <div class="col-12 col-md-6 pe-2">
                    ...
                    <div class="mb-3">
                        ...
                        <multiselect v-model="gameData.game_modes" tag-placeholder="Add this as new tag"
...
export default {
    ...
    methods: {
        ...
        async editarJuego() {
            ...
            await axios.put('/api/game', this.gameData)
                .then(respuesta => {
                    console.log(respuesta.data);
                    if (respuesta.status === 200) {
                        this.$toastr.s(`Juego "${this.gameData.title}" editado`);
                    }
                })
                .catch(error => {
                    console.log(error);
                    this.$toastr.e("Error al editar el juego");
                })
        }
    },
}
